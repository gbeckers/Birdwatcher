...
from src.birdwatcher.frames import create_frameswithmovingcircle
...
class TestBackgroundSubtractorKNN(unittest.TestCase):
    ...
    def test_KNNapply(self):
        bgs = bw.BackgroundSubtractorKNN(History=10)
        frames = create_frameswithmovingcircle(nframes=5, width=1080, height=720)
        for fg in frames.apply_backgroundsegmenter(
            bgs, roi=(10, 710, 10, 500), nroi=(20, 30, 20, 30)
        ):
            pass
